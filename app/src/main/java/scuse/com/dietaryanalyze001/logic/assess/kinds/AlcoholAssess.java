...
public class AlcoholAssess extends ComponentAssess {

    private static final String TAG = "OilAssess";

    public AlcoholAssess(int energy) {
        super(energy);
    }
