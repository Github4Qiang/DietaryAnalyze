 ...
 */
public class FruitsAssess extends ComponentAssess {

    private static final String TAG = "Fruits";

    public FruitsAssess(int energy) {
        super(energy);
    }
    ...
    public void fillAssessBeans() {
        switch (level) {
            case Constant.LEVEL_1:
                ...
                addBean2Level(0, new AssessBean(200, 0));
                break;
