...
public class SaltAssess extends ComponentAssess {

    private static final String TAG = "OilAssess";

    public SaltAssess(int energy) {
        super(energy);
    }
