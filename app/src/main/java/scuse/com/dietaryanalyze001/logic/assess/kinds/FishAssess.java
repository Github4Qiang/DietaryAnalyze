...
public class FishAssess extends ComponentAssess {

    private static final String TAG = "FishAssess";

    public FishAssess(int energy) {
        super(energy);
    }
    ...
    public void fillAssessBeans() {
        switch (level) {
            ...
            case Constant.LEVEL_3:
                ...
                addBean2Level(2, new AssessBean(75, 0));
                break;
            ...
            case Constant.LEVEL_6:
                ...
                addBean2Level(5, new AssessBean(100, 0));
                break;
            case Constant.LEVEL_7:
                addBean2Level(6, new AssessBean(0, -4));
                addBean2Level(6, new AssessBean(100, 0));
                break;
            default:
