 ...
 */
public class SoybeanAssess extends ComponentAssess {

    private static final String TAG = "Soybean";

    public SoybeanAssess(int energy) {
        super(energy);
    }
