 ...
 */
public class DairyAssess extends ComponentAssess {

    private static final String TAG = "Fruits";

    public DairyAssess(int energy) {
        super(energy);
    }
